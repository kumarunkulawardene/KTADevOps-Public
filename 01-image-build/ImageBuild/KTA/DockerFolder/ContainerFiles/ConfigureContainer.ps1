############################################################################
# ** Build Utility **
# This is a customisation of the KTA 7.9 product script that copies the appropriate 
# silent install into the installation media before executing product logic 
#
